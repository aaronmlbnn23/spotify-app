...
export const getTopArtists = (limit) => axios.get(`/me/top/artists?time_range=long_term&limit=${limit}`)
export const getArtist = (id) => axios.get(`/artists/${id}`)
export const getTopTracks = (limit) => axios.get(`/me/top/tracks?time_range=long_term&limit=${limit}`)
export const getSavedTracks = () => axios.get('/me/tracks')
